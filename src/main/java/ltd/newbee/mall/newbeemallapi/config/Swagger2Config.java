...
import ltd.newbee.mall.newbeemallapi.entity.AdminUserToken;
...
public class Swagger2Config {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("ltd.newbee.mall.newbeemallapi.api"))// 修改为自己的 controller 包路径
